...
from utils.clustering_centroid import Point, create_clusters # change import path as needed
import re 
    ...
    with open(prob_file, "r") as f:
        for line in f:
            try:
                ...
                if len(vals) == 5: # 2 or 5
                    ca_probs.append(vals[2]) # 1 or 2
